...
| gitalbRunnerConfig.gitlab_runner_version | Gitlab Runner Version| `string` | n/a | yes |
| gitalbRunnerConfig.docker_machine_version | Docker Machine Version| `string` | n/a | yes |
| gitalbRunnerConfig.secure_parameter_store_runner_token_key | SSM Parameter name for store Gitlab Token| `string` | n/a | yes |
| gitalbRunnerConfig.secure_parameter_store_region | SSM Parameter region| `string` | n/a | yes |
| gitalbRunnerConfig.gitlab_runner_registration_token | Gitlab Runner registration token| `string` | n/a | yes |
| gitalbRunnerConfig.gitlab_runner_tag_list | Gitlab Runner tags | `string` | n/a | yes |
| gitalbRunnerConfig.gitlab_runner_locked_to_project | Gitlab Runner Locked for Project | `string` | n/a | yes |
| gitalbRunnerConfig.gitlab_runner_run_untagged | Runner pipeline wiht untagged | `bool` | n/a | yes |
| gitalbRunnerConfig.gitlab_runner_maximum_timeout | Gitlab Runner timeout | `number` | n/a | yes |
